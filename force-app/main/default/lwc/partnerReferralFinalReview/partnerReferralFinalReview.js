 ...
 *   </c-partner-referral-review>
 *
 * The parent (partnerReferralFormLWC) mounts this at the top of the final
 * wizard step. It only reads props — it never mutates them.
 */
export default class PartnerReferralReview extends LightningElement {
