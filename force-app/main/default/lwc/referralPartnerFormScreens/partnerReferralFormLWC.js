...
import schemaResource from '@salesforce/resourceUrl/Partner_Referral_Questionnaire_Schema';
 ...
 */
export default class ReferralPartnerFormScreens extends LightningElement {
    ...
    _logError(context, error) {
        console.error(`[ReferralPartnerFormScreens:${context}]`, error?.message ?? error);
    }
}